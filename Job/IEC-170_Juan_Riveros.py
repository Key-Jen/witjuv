...
#01-07-25, Me cago en dios hicimos un gestor de usuarios pero pickle no bueno, anyways...
...
from auxiliares.usuarios import *
...
if usuario:
    ...
    print("Casi weon, casi")
    print("shaolin bombin")